...
/**
 * Created by Prasad on 12-May-18.
 */
public class SongsListAdapterHorizontal  extends BaseSongAdapter<SongsListAdapterHorizontal.ItemHolder> implements BubbleTextGetter {
    ...
    public SongsListAdapterHorizontal(AppCompatActivity context, List<Song> arraylist, boolean isPlaylistSong, boolean animate) {
    ...
    @Override
    public SongsListAdapterHorizontal.ItemHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        if (isPlaylist) {
            View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_song_playlist_horizontal, null);
            SongsListAdapterHorizontal.ItemHolder ml = new SongsListAdapterHorizontal.ItemHolder(v);
            return ml;
        } else {
            View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_song_horizontal, null);
            SongsListAdapterHorizontal.ItemHolder ml = new SongsListAdapterHorizontal.ItemHolder(v);
            return ml;
        }
    }
    ...
    @Override
    public void onBindViewHolder(SongsListAdapterHorizontal.ItemHolder itemHolder, int i) {
    ...
    private void setOnPopupMenuListener(SongsListAdapterHorizontal.ItemHolder itemHolder, final int position) {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        switch (item.getItemId()) {
                            ...
                            case R.id.popup_song_delete:
                                ...
                                TimberUtils.showDeleteDialog(mContext,arraylist.get(position).title, deleteIds, SongsListAdapterHorizontal.this, position);
                                break;
                        }
                        return false;
                    }
